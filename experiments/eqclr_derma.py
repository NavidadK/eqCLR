...
folder = 'results/dermamnist'
name_data = 'dermamnist_129'
N_CLASSES = 7
IN_CHANNELS = 3
IMG_RESIZE = 129  
...
for seed in range(3):
    ...
    data_train = DermaMNIST(split='train', download=False, size=128, root='data/dermamnist128/', transform=transform)
    data_test = DermaMNIST(split='test', download=False, size=128, root='data/dermamnist128/', transform=transform)
    data_val = DermaMNIST(split='val', download=False, size=128, root='data/dermamnist128/', transform=transform)
    print("Data loaded.")
    ...
    data_train_ssl = DermaMNIST(split='train', download=False, size=128, root='data/dermamnist128/', transform=paired_ssl_transforms)
    ...
    data_train_classifier = DermaMNIST(split='train', download=False, size=128, root='data/dermamnist128/', transform=transforms_classifier)
    ...
    for group in groups:
        ...
        for N in [2, 4, 8]:
            ...
            MODEL_FILENAME = f"C-0004_seed{seed}_{name_data}-mixed_eqCLR_resnet18_2eqblocks_N{N}_{group}_kp_1000epochs_lr{BASE_LR}"
            print(f"Model filename: {MODEL_FILENAME}")
